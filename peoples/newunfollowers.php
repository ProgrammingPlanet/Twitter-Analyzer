<div class="container-fluid px-0" id="newunfollowers" v-if="show">
	<!-- start page title -->
    <div class="row">
        <div class="col-12">
	...
	<!-- start newunfollowers component -->
    <div class="row">
    ...
    </div><!-- start newunfollowers component -->
...
<script type="text/javascript">
    ...
    var newunflr = new Vue({

        el: '#newunfollowers',
        data: {
        	show: false,
        	isloading: true,
        	title: "Peoples Who Unfollowed You",
            ids: [],
            users: [],
            lastfetched: "",
            chuncksize: 9
